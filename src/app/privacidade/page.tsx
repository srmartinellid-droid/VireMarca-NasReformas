    ...
    <div className="pt-28 pb-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-stone max-w-none space-y-6 text-stone-600">
          ...
          <p>Você pode solicitar acesso, correção ou exclusão de informações mantidas pela Nascimento Reformas entrando em contato pelo WhatsApp {SITE.whatsappDisplay}.</p>
          <h2 className="text-xl font-semibold text-navy-900">Contato</h2>
          <p>Para questões sobre privacidade: WhatsApp {SITE.whatsappDisplay}.</p>
