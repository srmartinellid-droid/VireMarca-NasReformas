...
export function Logo({ className, variant = "default", size = "md", showText = true, href = "/" }: LogoProps) {
  const [src,setSrc]=useState("/logo.png"); const [wordmark,setWordmark]=useState(""); const s=sizes[size];
