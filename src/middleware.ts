...
const VERCEL_ALIAS = "viremarca-nasreformas.vercel.app";
const OFFICIAL_HOST = "www.nascimentoreformas.com.br";

export async function middleware(request: NextRequest) {
  if (request.nextUrl.hostname === VERCEL_ALIAS) {
...
export const config = { matcher: ["/((?!_next|favicon.ico|icon.svg|apple-icon).*)"] };
